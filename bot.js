...
console.log("Bắt đầu kiểm tra token Discord...");
...
try {
  ...
  console.log("Kiểm tra token status:", meRes.status);
  console.log("Kiểm tra token body:", meText);
} catch (err) {
  console.error("Lỗi gọi API Discord:", err);
}

console.log("Bắt đầu login Discord...");

client.login(DISCORD_TOKEN).then(() => {
  console.log("Lệnh login đã gửi thành công.");
}).catch(err => {
